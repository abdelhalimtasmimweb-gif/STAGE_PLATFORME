...
export default function CompanyDetailsPage() {
  // ✅ Theme state côté client
  const [theme, setTheme] = useState<"light" | "dark">("light");
  const [company, setCompany] = useState<Company | null>(null);

  const [studentRating, setStudentRating] = useState<number>(0);

  // ⚡️ Initialisation theme après montage
  useEffect(() => {
    const savedTheme = localStorage.getItem("theme") as "light" | "dark";
    if (savedTheme) setTheme(savedTheme);
  }, []);

  // ⚡️ Mock data côté client après montage
  useEffect(() => {
      ...
      <div className="w-full max-w-4xl bg-white dark:bg-gray-700 rounded-2xl shadow-xl p-8">
        ...
        <div className="mt-8 flex space-x-4">
          ...
          {company.twitter && (
           ...
           <LocationMap locationUrl="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2790.636185013959!2d-4.454222474654638!3d31.93930737632639!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd984a404b35d00d%3A0xc08aa98998952aac!2z2YPZhNmK2Kkg2KfZhNi52YTZiNmFINmI2KfZhNiq2YLZhtmK2KfYqg!5e1!3m2!1sar!2sma!4v1760353798331!5m2!1sar!2sma"/>

           <div>


                    <div className="mt-6">
  <h2 className="text-xl font-semibold mb-2">⭐ Donnez votre avis</h2>
  <RatingStars
  ...
  />
    ...
    <p className="mt-2 text-gray-700">
      Vous avez donné <strong>{studentRating}</strong> étoile{studentRating > 1 ? "s" : ""} à cette entreprise.
    </p>
  )}
   ...
   <div className="">
       ...
       <CommentsSection
  initialComments={[
    { id: 1, author: "Amine", content: "Super entreprise !", createdAt: "12/10/2025, 16:30" },
    { id: 2, author: "Sara", content: "Bon accueil lors du stage.", createdAt: "11/10/2025, 09:45" },
  ]}
  onNewComment={(newComment) => {
    console.log("Nouveau commentaire :", newComment);
    // Tu peux ici l’envoyer à ton backend
  }}
/>
   </div>
           </div>
